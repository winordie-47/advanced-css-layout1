...
- Today's lesson was all about new ways to manage the visual structure of a view, adding custom typography, iconography and responsive imagery.
- For the homework, I would like to see the following:
  - Taking the project you re-factored, use a combination of a grid system and flexbox to re-engineer the layout of the view.
  - In correlation with the design, or go out in a limb, add custom web fonts
  - In correlation with the design, or go out in a limb, add ico-fonts to the project
